...
#define UPCXXI_MAXEPS 1 
#undef UPCXXI_GEX_MK_CUDA
#undef UPCXXI_GEX_MK_HIP
#undef UPCXXI_GEX_MK_ZE
#undef UPCXXI_NATIVE_NP_ALLOC_REQ_MEDIUM // GASNET_NATIVE_NP_ALLOC_REQ_MEDIUM not defined
