...
#     include $(GASNET_PREFIX)/include/udp-conduit/udp-seq.mak
# or alternatively, just:
#     include udp-seq.mak
# and use a -I$(GASNET_PREFIX)/include/udp-conduit
...
GASNET_LD_OVERRIDE = /usr/bin/mpicxx
GASNET_LDFLAGS_OVERRIDE = -O2  -Wno-array-bounds -Wno-stringop-overflow -Wno-dangling-pointer -Wno-use-after-free -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address -Wl,--build-id 
...
GASNET_INCLUDES = -I$(GASNET_PREFIX)/include -I$(GASNET_PREFIX)/include/udp-conduit $(CONDUIT_INCLUDES) $(CONDUIT_INCLUDES_SEQ)
