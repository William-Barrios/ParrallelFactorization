...
#     include $(GASNET_PREFIX)/include/ibv-conduit/ibv-seq.mak
# or alternatively, just:
#     include ibv-seq.mak
# and use a -I$(GASNET_PREFIX)/include/ibv-conduit
...
GASNET_LDFLAGS_OVERRIDE = -O3 --param max-inline-insns-single=35000 --param inline-unit-growth=10000 --param large-function-growth=200000  -Wno-array-bounds -Wno-stringop-overflow -Wno-dangling-pointer -Wno-use-after-free -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address -Wl,--build-id
...
GASNET_LD_OVERRIDE = /usr/bin/mpicc
GASNET_LDFLAGS_OVERRIDE = -D_GNU_SOURCE=1 -O3 --param max-inline-insns-single=35000 --param inline-unit-growth=10000 --param large-function-growth=200000  -Wno-array-bounds -Wno-stringop-overflow -Wno-dangling-pointer -Wno-use-after-free -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address  -Wl,--build-id
MPI_COMPAT_LIBS = 
...
CONDUIT_LDFLAGS =    -Wl,--start-group -Wl,--end-group 
CONDUIT_LIBS = -libverbs $(MPI_COMPAT_LIBS) $(SSH_LIBS)  -lhwloc -L/usr/lib/x86_64-linux-gnu/stubs -L/usr/lib/x86_64-linux-gnu -lcudadevrt -lcudart_static -lrt -lpthread -ldl -lcuda 
...
GASNET_INCLUDES = -I$(GASNET_PREFIX)/include -I$(GASNET_PREFIX)/include/ibv-conduit $(CONDUIT_INCLUDES) $(CONDUIT_INCLUDES_SEQ)
...
GASNET_MISC_CFLAGS =  -Wno-array-bounds -Wno-stringop-overflow -Wno-dangling-pointer -Wno-use-after-free -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address $(CONDUIT_MISC_CFLAGS) $(CONDUIT_MISC_CFLAGS_SEQ)
GASNET_MISC_CPPFLAGS =  $(CONDUIT_MISC_CPPFLAGS) $(CONDUIT_MISC_CPPFLAGS_SEQ)
GASNET_DEVWARN_CFLAGS =  -Winline -Wall -Wpointer-arith -Wnested-externs -Wwrite-strings -Wmissing-format-attribute -Winit-self -Wvla -Wexpansion-to-defined -Woverlength-strings -Wclobbered -Wcast-function-type -Wempty-body -Wignored-qualifiers -Wimplicit-fallthrough -Wmissing-parameter-type -Wold-style-declaration -Wuninitialized -Wshift-negative-value -Wno-format-overflow -Wno-format-truncation -Wno-strict-prototypes $(CONDUIT_DEVWARN_CFLAGS) $(CONDUIT_DEVWARN_CFLAGSSEQ)

# ----------------------------------------------------------------------
# C++ compiler and options
# TODO: some options (especially CONDUIT_*) are not distinct from C compiler

GASNET_CXX = /usr/bin/mpicxx

GASNET_OPT_CXXFLAGS = -O2 $(CONDUIT_OPT_CFLAGS) $(CONDUIT_OPT_CFLAGS_SEQ)
GASNET_MISC_CXXFLAGS =  -Wno-array-bounds -Wno-stringop-overflow -Wno-dangling-pointer -Wno-use-after-free -Wno-unused -Wunused-result -Wno-unused-parameter -Wno-address $(CONDUIT_MISC_CFLAGS) $(CONDUIT_MISC_CFLAGS_SEQ)
...
GASNET_LIBS =                             \
    ...
    $(GASNET_EXTRALIBS_SEQ)    \
                        \
    -L/usr/lib/gcc/x86_64-linux-gnu/13 -lgcc                              \
                                    \
    -lm                                \
    $(MANUAL_LIBS)
