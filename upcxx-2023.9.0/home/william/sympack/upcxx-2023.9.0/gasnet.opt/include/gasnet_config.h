...
#define GASNETI_BUILD_ID "Mon Nov 11 13:29:37 -05 2024 william"
#define GASNETI_CONFIGURE_ARGS "'--enable-kind-cuda-uva' '--with-cc=/usr/bin/mpicc' '--with-cflags=' '--with-cxx=/usr/bin/mpicxx' '--with-cxxflags=' '--with-ldflags=-Wl,--build-id ' '--disable-parsync' '--enable-seq' '--enable-par' '--enable-pthreads' '--disable-segment-everything' '--disable-ibv-rcv-thread' '--disable-debug'"
#define GASNETI_SYSTEM_TUPLE "x86_64-pc-linux-gnu"
#define GASNETI_SYSTEM_NAME "DESKTOP-IPGED33"
/* #undef GASNETI_CROSS_COMPILING */

/* version identifiers */
#define GASNET_RELEASE_VERSION_MAJOR 2023
#define GASNET_RELEASE_VERSION_MINOR 9
#define GASNET_RELEASE_VERSION_PATCH 0
#define GASNETI_RELEASE_VERSION 2023.9.0
...
#define GASNETI_EX_SPEC_VERSION_MINOR 17
...
#define GASNETI_HAVE_CXX_CXX11_ATTRIBUTE_CLANG__FALLTHROUGH 0
...
#define GASNETI_PLATFORM_COMPILER_IDSTR "|COMPILER_FAMILY:GNU|COMPILER_VERSION:13.2.0|COMPILER_FAMILYID:1|STD:__STDC__,__STDC_VERSION__=201710L|misc:13.2.0|"
#define GASNETI_PLATFORM_COMPILER_FAMILYID 1
#define GASNETI_PLATFORM_COMPILER_ID 1
#define GASNETI_PLATFORM_COMPILER_VERSION 852480
#define GASNETI_PLATFORM_COMPILER_C_LANGLVL 201710

/* identification of the C++ compiler used at configure time */
#define GASNETI_PLATFORM_CXX_IDSTR "|COMPILER_FAMILY:GNU|COMPILER_VERSION:13.2.0|COMPILER_FAMILYID:1|STD:__STDC__,__cplusplus=201703L|misc:13.2.0|"
#define GASNETI_PLATFORM_CXX_FAMILYID 1
#define GASNETI_PLATFORM_CXX_ID 10001
#define GASNETI_PLATFORM_CXX_VERSION 852480
#define GASNETI_PLATFORM_CXX_CXX_LANGLVL 201703

/* identification of the MPI C compiler used at configure time */
#define GASNETI_PLATFORM_MPI_CC_IDSTR "|COMPILER_FAMILY:GNU|COMPILER_VERSION:13.2.0|COMPILER_FAMILYID:1|STD:__STDC__,__STDC_VERSION__=201710L|misc:13.2.0|"
#define GASNETI_PLATFORM_MPI_CC_FAMILYID 1
#define GASNETI_PLATFORM_MPI_CC_ID 1
#define GASNETI_PLATFORM_MPI_CC_VERSION 852480
...
#define GASNETI_COMMON __attribute__((__common__))
...
#define GASNETI_MK_CLASS_CUDA_UVA_ENABLED 1
...
#define GASNETI_HAVE_HWLOC_LIB 1
...
#define GASNETI_TM0_ALIGN 128

/* udp-conduit default custom spawn command */
#define GASNET_CSPAWN_CMD "mpirun -np %N %C"
...
#define GASNETC_UCX_SPAWNER_CONF "mpi"
#define GASNETC_UCX_MAX_MEDIUM_DFLT 3992

/* GASNet ibv-conduit features and bug work-arounds */
#define GASNETC_IBV_SPAWNER_CONF "mpi"
...
#define GASNETC_IBV_FENCED_PUTS_CONFIGURE 1
#define GASNETC_IBV_SERIALIZE_POLL_CQ_CONFIGURE 1
...
/* Define to 1 if you have the `ibv_wc_status_str' function. */
...
/* Define to 1 if you have the `PMI_Allgather_on_smp' function. */
/* #undef HAVE_PMI_ALLGATHER_ON_SMP */

/* Define to 1 if you have the `PMI_Bcast' function. */
/* #undef HAVE_PMI_BCAST */

/* Define to 1 if you have the `PMI_Get_numpes_on_smp' function. */
/* #undef HAVE_PMI_GET_NUMPES_ON_SMP */
