...
#define GASNETI_BUILD_ID "Mon Nov 11 13:27:49 -05 2024 william"
#define GASNETI_CONFIGURE_ARGS "'--enable-kind-cuda-uva' '--with-cc=/usr/bin/mpicc' '--with-cflags=' '--with-cxx=/usr/bin/mpicxx' '--with-cxxflags=' '--with-ldflags=-Wl,--build-id ' '--disable-parsync' '--enable-seq' '--enable-par' '--enable-pthreads' '--disable-segment-everything' '--disable-ibv-rcv-thread' '--enable-debug'"
